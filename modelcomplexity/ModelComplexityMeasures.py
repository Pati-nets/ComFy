...
analyzed_model_complexity_measures = [Size(), ConnectorMismatch(), ConnectorHeterogeneity(),
                                      TokenSplit(), ControlFlowComplexity(), Separability(),
                                      AverageConnectorDegree(), MaximumConnectorDegree(), Sequentiality(),
